        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                if ($_POST['student'] === 'y' && isset($_POST['rollno'])) {
                    ...
                    // Set headers with sticky positioning
                    echo "<tr>";
                    echo "<th style='position: sticky; left: 0; background-color: #f8f9fa; z-index: 2;'>Subject</th>"; // Fixed subject header
                    ...
                    echo "<th style='position: sticky; left: 150px; background-color: #f8f9fa; z-index: 2;'>Total</th>"; // Fixed total column
                    echo "<th style='position: sticky; left: 200px; background-color: #f8f9fa; z-index: 2;'>%</th>"; // Fixed percentage column
                    echo "</tr>";
                    ...
                    for ($nosub = 0; $nosub < count($result3); $nosub++) {
                        ...
                        echo "<td style='position: sticky; left: 0; background-color: #f8f9fa; z-index: 1;'><h6>$sub</h6></td>";
                        ...
                        $dtper = $dtlec ? round((100 * $dpresent) / $dtlec, 2) : 0;

                        // Fixed total and percentage columns
                        echo "<td style='position: sticky; left: 150px; background-color: #f8f9fa; z-index: 1;'><strong>" . $dpresent . "</strong>/" . $dtlec . "</td>";
                        echo "<td style='position: sticky; left: 200px; background-color: #f8f9fa; z-index: 1;'>
