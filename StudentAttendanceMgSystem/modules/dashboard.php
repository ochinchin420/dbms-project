						  ...
						  if(($weekday != "saturday") && ($weekday != "sunday")) {
							  for($j = 0; $j < $noOfSubjectPending; $j++) {
								  ...
								  if(!empty($resultP)) {
									  ...
									  echo "<p>Class: <strong style='color:#555;'>" . $rsubPending[$j]['name'] . "</strong> of <strong>" . $dateCurrent . "</strong> <span class='label label-success' style='border-radius:0%;'>Attendance Recorded</span></p>";
								  } else {
									  // Link is moved to the "Mark Attendance Now!" text
									  echo "<p>Class: <strong style='color:#555;'>" . $rsubPending[$j]['name'] . "</strong> of <strong>" . $dateCurrent . "</strong></p>";
									  echo "<p><a href='index.php?subject=" . $subIdP . "&date=" . $dateCurrentYMD . "' style='text-decoration:none;'><span class='label label-danger' style='border-radius:0%;'>Mark Attendance Now!</span></a></p>";
								  }
							  }
				  ...
				  <?php
					  ...
					  for($i = 0; $i<$noOfSubject; $i++) {
						  ...
						  if(!empty($result)){
							  ...
							  echo "<p>Class: <strong style='color:#555;'>" . $rsub[$i]['name'] . "</strong> of <strong>" . $todayQuery . "</strong></p>";
							  echo "<p><a href='index.php?subject=" . $subId . "&date=" . $todayQuery . "' style='text-decoration:none;'><span class='label label-danger' style='border-radius:0%;'>Mark Attendance Now!</span></a></p>";
